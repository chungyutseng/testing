...
pub_pose_marker_lp = rospy.Publisher("/drone2/tello_pose_marker_lp", numpy_msg(Floats), queue_size=10)
...
def get_marker_message(marker_msg):
    ...
    if count >= 4:
        ...
        tello_pose_marker_lp[4] = (1.0 / 5.0) * (temp[4] + pxs[3] + pxs[2] + pxs[1] + pxs[0])

...
pub_marker_detected_flag = rospy.Publisher("marker_detected_t", Float32, queue_size=10)
pub_transformation_array_positioning = rospy.Publisher('transformation_array_positioning_t', numpy_msg(Floats), queue_size=10)
pub_pose_marker = rospy.Publisher('tello_pose_marker_t', numpy_msg(Floats), queue_size=10)
...
rospy.Subscriber('tello_pose_kf_t', numpy_msg(Floats), callback=get_kf_position)
